...
function findJobs(jobs) {
  // Do il valore di title che viene calcolato nella funzione all'elemento che ha come id "title" in html
  const title = document.getElementById("title").value;
  // Do il valore di location che viene calcolato nella funzione all'elemento che ha come id "locationinput" in html
  ...
  jobs.forEach(job => {
    ...
    if (lowercaseTitle.includes(title) && lowercaseLocation.includes(location)) {
      ...
      // Crea un nodo di testo per il titolo del lavoro
      const titleNode = document.createTextNode(job.title);

      // Crea un nodo di testo per la posizione del lavoro
      const locationNode = document.createTextNode(" " + job.location);

      // Aggiungi i nodi di testo all'elemento <li>
      listItem.appendChild(titleNode);
      listItem.appendChild(locationNode);
      // Aggiungi l'elemento <li> alla lista dei lavori
...
// Chiamare la funzione "findJobs" passando l'array "jobs" come argomento
findJobs(jobs);
